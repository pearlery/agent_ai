...
class Config:
    def __init__(self):
        ...
        self.DURABLE_NAME = os.getenv("DURABLE_NAME", "model_server_durable_context_agent")
        self.INPUT_SUBJECT = self.STREAM_PREFIX + os.getenv("INPUT_SUBJECT_SUFFIX", ".Context")
